...
from dataset import InstructDataset, ChatDataset, QAKnwDataset
...
def train(
    ...
    tokenizer_name = "/opt/models/LLaMa/HF/fix_tokenizer"
    ...
    if mode == "instruct" or mode == "qaknw":
    ...
    print(f"Embedding size: {model.get_input_embeddings().weight.shape[0]}") ##Added
...
if __name__ == "__main__":
    train(config_file="llama_7b_lora.json",
          train_file="vs_train.jsonl",
          val_file="vs_val.jsonl",
          checkpoint=None,
          output_dir="mu",
